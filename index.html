...
<head>
  ...
  <title>StblissArt Portfolio</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="photos/icon-portrait-young.jpg" rel="icon">
  <link href="photos/icon-portrait-young.jpg" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        <img src="photos/profile-portrait.jpg" alt="" class="img-fluid rounded-circle">
        <h1 class="text-light"><a href="index.html">StblissArt</a></h1>
        <div class="social-links mt-3 text-center">
          <a href="https://www.instagram.com/stblissart/" class="instagram"><i class="bx bxl-instagram"></i></a>
          <a href="https://web.facebook.com/stblissart/?ref=pages_you_manage" class="facebook"><i class="bx bxl-facebook"></i></a>
  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4" data-aos="fade-right">
            <img src="../iPortfolio/photos/profile-portrait.jpg" class="img-fluid" alt="">
          </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="bi bi-chevron-right"></i> <strong>PhEmailone:</strong> <span>stbliss75@gmail.com</span></li>
        ...
        <div class="row">
          <div class="col-lg-6" data-aos="fade-up">
            ...
            <div class="resume-item pb-0">
              <h4>StblissArt</h4>
              <p><em>Innovative and deadline-driven Designer with 3+ years of experience designing and developing user-centered digital/print marketing material from initial concept to final, polished deliverable.</em></p>
              <ul>
                <li>77 wetheral road, opposite owerri city school owerri imo state, Nigeria.</li>
                <li>(+234) 8103111163</li>
                <li>stbliss75@gmail.com</li>
              </ul>
            </div>

            <h3 class="resume-title">Education</h3>
            <div class="resume-item">
              <h4>Bio-reources Engineering</h4>
              <h5>2011 - 2016</h5>
              <p><em>Micheal Okpara University Umuahia, Abia State, Nigeria</em></p>
              <p>Micheal Okpara is a tertiary institution in Abia State Nigeria, where i learnt so much about life and i bagged my first degree in Engineering </p>
            </div>
            <div class="resume-item">
              <h4>Digital Arts &amp; Web Developer/Design</h4>
              <h5>2019 - 2021</h5>
              <p><em>Scoondytoon Academy &amp; Owerri City Hub Owerri, Imo State</em></p>
              <p>when the pandemic came, a lot of people lost their jobs, i saw a need for a skill not just a skill but a skill that does not demand your presence to get it done, basically i had to develop myself to be able to remain relevant. </p>
            </div>
          </div>
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <h3 class="resume-title">Professional Experience</h3>
            <div class="resume-item">
              <h4>Digital Artiste &amp; Web Developer</h4>
              <h5>2019 - Present</h5>
            ...
            <div class="resume-item">
              ...
              <h5>2019 - 2020</h5>
              <p><em>Stepping Stone Advertising, Owerri, Nigeria</em></p>
              <ul>s
                <li>Developed numerous marketing programs (logos, brochures,infographics, presentations, and advertisements).</li>
                <li>Managed up to 5 projects or tasks at a given time while under pressure</li>
                <li>Recommended and consulted with clients on the most appropriate designs</li>
                <li>Created 3+ design presentations and proposals a month for clients and account managers</li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Services</h2>
          <p>These are the range of services we offer to our esteemed clients with excellence, perfection, love and emotions, We are professional and delivers timely.</p>
        </div>

        <div class="row">
          <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
            <div class="icon"><i class="bi bi-briefcase"></i></div>
            <h4 class="title"><a href="">Web Development/Designer</a></h4>
            <p class="description">We offer web Programming services, Also known as Web application, it's the creation of dynamic web applications.</p>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
            <div class="icon"><i class="bi bi-card-checklist"></i></div>
            <h4 class="title"><a href="">3D Painting</a></h4>
            <p class="description">3D Painting is known to be a 3dimensional painting  which always includes the Highlights and Shadows, we offer this service and we give our best</p>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="200">
            <div class="icon"><i class="bi bi-bar-chart"></i></div>
            <h4 class="title"><a href="">Smudge Portraite Painting</a></h4>
            <p class="description">this is were photograghy meets with Oil Painting</p>
          </div>
        </div>
    ...
    <section id="testimonials" class="testimonials section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Testimonials</h2>
        <p>these are reviews from our awesome clients from around the globe who believes with all conviction that Stblissart is 100% a professional setup for beautiful Art and stunning Web Designs.</p>
        </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item" data-aos="fade-up" data-aos-delay="100">
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  Just a quick note to say the painting is absolutely incredible in every way, To be honest, I was getting concerned but the final product is nothing short of outstanding Thank you so much, it is fabulous Also, can I please commission another painting Size should be 200cm tall x 140cm wide.
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item" data-aos="fade-up" data-aos-delay="200">
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  Thank you StblissArt. I really love all the work you guys do. 100% satisfied with everything as you can tell by the fact that I keep coming back, Can’t wait to have another paintings from you, Have a nice day as well.
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item" data-aos="fade-up" data-aos-delay="400">
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  Thank you for your e-mail, StblissArt. I am excited to receive the Art work. The other pieces that I have ordered from you look fantastic in my home ! Stay healthy ! Kind regards,.
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>77 wetheral road, opposite owerri city school owerri imo state, Nigeria.</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>stbliss75@gmail.com</p>
              </div>
              ...
              <iframe src="https://maps.google.com/maps?q=77%20wetheral%20road,%20opposite%20owerri%20city%20school%20owerri%20imo%20state&t=&z=5&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://fmovies-online.net"></a><br><style>.mapouter{position:relative;text-align:right;height:400px;width:400px;}</style><a href="https://www.embedgooglemap.net">google map websites</a><style>.gmap_canvas {overflow:hidden;background:none!important;height:400px;width:400px;}</style></div></div>
            </div>
